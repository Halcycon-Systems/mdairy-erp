...
We as members, contributors, and leaders pledge to make participation in the mDairy ERP community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, colour, religion, or sexual identity and orientation.
...
This Code of Conduct applies within all community spaces, and also when an individual is officially representing the community in public spaces (e.g. using an official project email address, posting via an official social media account, or acting as an appointed representative at an event).

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the project maintainers. All complaints will be reviewed promptly and investigated fairly.
...
**Consequence:** A private written warning with an explanation of why the behaviour was inappropriate. A public apology may be requested.
